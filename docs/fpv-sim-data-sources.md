...
- `docs/data/a4mc_source_quality_response_packet.csv` adds a `1329`-row A4MC source-quality response matrix mirrored as `a4mc_source_quality_packet_*`. It varies trust, confidence, freshness, shelter, and shear, then records the core-adopted source gust, terrain-shear, local-voxel ventilation, and local-obstacle residual responses.
