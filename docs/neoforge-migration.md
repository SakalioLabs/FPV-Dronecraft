...
| 9d | Fabric compatibility consumer | Keep the comparison loader aligned with the upgraded shared-core state and atmosphere contracts | Complete | This commit; 439 Fabric tests and 9/9 Fabric GameTests pass |
