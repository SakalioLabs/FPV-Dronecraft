...
- A4MC shear/updraft diagnostics add a bounded terrain-shear gust component to the effective air mass, making blackbox wind-shear acceleration respond to local voxel flow instead of only mean wind changes,
