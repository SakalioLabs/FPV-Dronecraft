...
public final class PropellerArchiveCtCpJWorldForceApplicationProvider {
	...
	public record WorldForceApplicationSample(
		...
		public AirframePressureCenterModel.AirframePressureCenterSample steadyAirframePressureCenterSample(
				DroneConfig config,
				double separatedFlowStateIntensity
		) {
		...
		public AirframeLiftForceModel.AirframeLiftForceSample steadyAirframeLiftSample(
				DroneConfig config,
				double separatedFlowStateIntensity
		) {
			AirframeDragForceModel.AirframeDragForceSample dragSample = steadyAirframeDragSample(
		...
		public RotorFlappingForceModel.ConfigurationRotorFlappingForceSample baselineRotorFlappingForceSample() {
			return baselineRotorFlappingForceSample(false);
		}

		public RotorFlappingForceModel.ConfigurationRotorFlappingForceSample
				runtimeReplacementBaselineRotorFlappingForceSample() {
			return baselineRotorFlappingForceSample(true);
		}

		public RotorObliqueInflowMomentModel.ConfigurationRotorObliqueInflowSample
				baselineRotorObliqueInflowSample() {
			return baselineRotorObliqueInflowSample(false);
		}

		public RotorObliqueInflowMomentModel.ConfigurationRotorObliqueInflowSample
				runtimeReplacementBaselineRotorObliqueInflowSample() {
		...
		public RotorAngularRateDampingModel.ConfigurationRotorAngularRateDampingSample
				runtimeReplacementBaselineRotorAngularRateDampingSample(
						Vec3 angularVelocityBodyRadiansPerSecond
				) {
			return baselineRotorAngularRateDampingSample(angularVelocityBodyRadiansPerSecond, true);
		}
		...
		public RigidBodyWrenchSample rotorGravityTransientAirframeDragRigidBodyWrench(
				DroneConfig config,
				double[] previousOmegaRadiansPerSecond,
				double[] omegaRadiansPerSecond,
				Vec3 angularVelocityBodyRadiansPerSecond,
		...
		public RigidBodyWrenchSample runtimeReplacementRotorGravityTransientAirframeDragRigidBodyWrench(
				DroneConfig config,
				double[] previousOmegaRadiansPerSecond,
				double[] omegaRadiansPerSecond,
				Vec3 angularVelocityBodyRadiansPerSecond,
		...
		public RigidBodyWrenchSample rotorGravityTransientCrossflowLiftDragRigidBodyWrench(
				DroneConfig config,
				double[] previousOmegaRadiansPerSecond,
				double[] omegaRadiansPerSecond,
				Vec3 angularVelocityBodyRadiansPerSecond,
		...
		public RigidBodyWrenchSample runtimeReplacementRotorGravityTransientCrossflowLiftDragRigidBodyWrench(
				DroneConfig config,
				double[] previousOmegaRadiansPerSecond,
				double[] omegaRadiansPerSecond,
				Vec3 angularVelocityBodyRadiansPerSecond,
		...
		public RigidBodyWrenchSample rotorGravityTransientPassiveAerodynamicRigidBodyWrench(
			...
			return withBaselineRotorObliqueInflowMoment(
					withBaselineRotorAngularRateDamping(
							withBaselineRotorFlappingForces(
									withPassiveAirframeAngularDamping(
		...
		public RotorOnlyStepPreview rotorGravityTransientAirframeDragStepPreview(
				DroneConfig config,
				Vec3 positionWorldMeters,
				Vec3 velocityWorldMetersPerSecond,
				Vec3 angularVelocityBodyRadiansPerSecond,
		...
		public RotorOnlyStepPreview runtimeReplacementRotorGravityTransientAirframeDragStepPreview(
				DroneConfig config,
				Vec3 positionWorldMeters,
				Vec3 velocityWorldMetersPerSecond,
				Vec3 angularVelocityBodyRadiansPerSecond,
		...
		public RotorOnlyStepPreview rotorGravityTransientCrossflowLiftDragStepPreview(
				DroneConfig config,
				Vec3 positionWorldMeters,
				Vec3 velocityWorldMetersPerSecond,
				Vec3 angularVelocityBodyRadiansPerSecond,
		...
		public RotorOnlyStepPreview runtimeReplacementRotorGravityTransientCrossflowLiftDragStepPreview(
				DroneConfig config,
				Vec3 positionWorldMeters,
				Vec3 velocityWorldMetersPerSecond,
				Vec3 angularVelocityBodyRadiansPerSecond,
		...
		private RigidBodyWrenchSample withAirframeDragWrench(
				RigidBodyWrenchSample baseWrench,
				DroneConfig config,
				Vec3 angularVelocityBodyRadiansPerSecond,
				double separatedFlowStateIntensity
		...
		private RigidBodyWrenchSample withAirframeDrag(
				RigidBodyWrenchSample baseWrench,
				DroneConfig config,
				Vec3 angularVelocityBodyRadiansPerSecond,
				double separatedFlowStateIntensity,
				boolean includePressureCenterTorque
		) {
			AirframeDragForceModel.AirframeDragForceSample dragSample = steadyAirframeDragSample(
					config,
					separatedFlowStateIntensity
			);
			Vec3 pressureCenterTorqueWorld = Vec3.ZERO;
			if (includePressureCenterTorque) {
				pressureCenterTorqueWorld = airframePressureCenterSample(config, dragSample)
						.pressureCenterTorqueWorldNewtonMeters(bodyToWorldOrientation);
			}
			return rigidBodyWrench(
					config,
					...
					baseWrench.totalTorqueWorldNewtonMeters().add(pressureCenterTorqueWorld),
					angularVelocityBodyRadiansPerSecond,
		...
		private RigidBodyWrenchSample withBaselineRotorFlappingForces(
				RigidBodyWrenchSample baseWrench,
				DroneConfig config,
				Vec3 angularVelocityBodyRadiansPerSecond,
				boolean runtimeReplacement
		) {
			RotorFlappingForceModel.ConfigurationRotorFlappingForceSample flappingSample = runtimeReplacement
					? runtimeReplacementBaselineRotorFlappingForceSample()
					: baselineRotorFlappingForceSample();
			return rigidBodyWrench(
					config,
					baseWrench.totalForceWorldNewtons().add(
							flappingSample.totalFlappingForceWorldNewtons(bodyToWorldOrientation)
					),
					baseWrench.totalTorqueWorldNewtonMeters().add(
							flappingSample.totalTorqueCorrectionWorldNewtonMeters(bodyToWorldOrientation)
					),
					angularVelocityBodyRadiansPerSecond,
					baseWrench.runtimeReplacement()
			);
		...
		private RigidBodyWrenchSample withBaselineRotorAngularRateDamping(
				RigidBodyWrenchSample baseWrench,
				DroneConfig config,
				Vec3 angularVelocityBodyRadiansPerSecond,
				boolean runtimeReplacement
		) {
			RotorAngularRateDampingModel.ConfigurationRotorAngularRateDampingSample dampingSample =
					runtimeReplacement
							? runtimeReplacementBaselineRotorAngularRateDampingSample(
									angularVelocityBodyRadiansPerSecond
							)
							: baselineRotorAngularRateDampingSample(angularVelocityBodyRadiansPerSecond);
			return rigidBodyWrench(
					config,
					baseWrench.totalForceWorldNewtons(),
					baseWrench.totalTorqueWorldNewtonMeters().add(
							dampingSample.totalDampingTorqueWorldNewtonMeters(bodyToWorldOrientation)
					),
					angularVelocityBodyRadiansPerSecond,
					baseWrench.runtimeReplacement()
			);
		...
		private RigidBodyWrenchSample withBaselineRotorObliqueInflowMoment(
				RigidBodyWrenchSample baseWrench,
				DroneConfig config,
				Vec3 angularVelocityBodyRadiansPerSecond,
				boolean runtimeReplacement
		) {
			RotorObliqueInflowMomentModel.ConfigurationRotorObliqueInflowSample obliqueInflowSample =
					runtimeReplacement
							? runtimeReplacementBaselineRotorObliqueInflowSample()
							: baselineRotorObliqueInflowSample();
			return rigidBodyWrench(
					...
					baseWrench.totalForceWorldNewtons(),
					baseWrench.totalTorqueWorldNewtonMeters().add(
							obliqueInflowSample.totalHubMomentWorldNewtonMeters(bodyToWorldOrientation)
					),
					angularVelocityBodyRadiansPerSecond,
					baseWrench.runtimeReplacement()
			);
		...
		private RigidBodyWrenchSample withAirframeLift(
				RigidBodyWrenchSample baseWrench,
				DroneConfig config,
				Vec3 angularVelocityBodyRadiansPerSecond,
				double separatedFlowStateIntensity
			...
			AirframeLiftForceModel.AirframeLiftForceSample liftSample = airframeLiftSample(
					config,
					dragSample
			);
			AirframePressureCenterModel.AirframePressureCenterSample dragPressureCenter =
					airframePressureCenterSample(config, dragSample);
			AirframePressureCenterModel.AirframePressureCenterSample combinedPressureCenter =
					AirframePressureCenterModel.sampleSteady(
							config,
							relativeAirVelocityBodyMetersPerSecond,
							dragSample.bodyDragForceBodyNewtons().add(
									liftSample.totalLiftForceBodyNewtons()
							),
							dragSample.effectiveSeparationIntensity()
					);
			Vec3 pressureCenterTorqueDeltaWorld = combinedPressureCenter
					.pressureCenterTorqueWorldNewtonMeters(bodyToWorldOrientation)
					.subtract(dragPressureCenter.pressureCenterTorqueWorldNewtonMeters(
							bodyToWorldOrientation
					));
			return rigidBodyWrench(
					config,
		...
		private RotorFlappingForceModel.ConfigurationRotorFlappingForceSample baselineRotorFlappingForceSample(
				boolean runtimeReplacement
		) {
			List<RotorFlappingForceModel.RotorFlappingForceSample> samples = new ArrayList<>();
			for (PropellerArchiveCtCpJRotorForceModel.RotorForceSample rotorSample
					: aggregate.rotorSamples()) {
				boolean applied = runtimeReplacement
						? rotorSample.runtimeForceReplacementAccepted()
				...
				double omegaRadiansPerSecond = rotorSample.query().rpm() * 2.0 * Math.PI / 60.0;
				samples.add(RotorFlappingForceModel.sampleSteady(
						rotorSample.query().rotor(),
						rotorSample.momentArmBodyMeters(),
						rotorSample.relativeAirVelocityBodyMetersPerSecond(),
						Vec3.ZERO,
						omegaRadiansPerSecond,
						rotorSample.thrustNewtons(),
						rotorSample.reactionTorqueBodyNewtonMeters()
				));
			}
			return RotorFlappingForceModel.aggregate(samples);
		}

		private RotorObliqueInflowMomentModel.ConfigurationRotorObliqueInflowSample
				baselineRotorObliqueInflowSample(boolean runtimeReplacement) {
			List<RotorObliqueInflowMomentModel.RotorObliqueInflowSample> samples = new ArrayList<>();
			for (PropellerArchiveCtCpJRotorForceModel.RotorForceSample rotorSample
					: aggregate.rotorSamples()) {
				boolean applied = runtimeReplacement
						? rotorSample.runtimeForceReplacementAccepted()
				...
				double omegaRadiansPerSecond = rotorSample.query().rpm() * 2.0 * Math.PI / 60.0;
				samples.add(RotorObliqueInflowMomentModel.sampleSteady(
						rotorSample.query().rotor(),
						rotorSample.relativeAirVelocityBodyMetersPerSecond(),
						omegaRadiansPerSecond,
						rotorSample.thrustNewtons(),
						rotorSample.dimensionalSample().idealInducedVelocityMetersPerSecond(),
						0.0
				));
			}
		...
		private RotorAngularRateDampingModel.ConfigurationRotorAngularRateDampingSample
				baselineRotorAngularRateDampingSample(
						Vec3 angularVelocityBodyRadiansPerSecond,
						boolean runtimeReplacement
				) {
			List<RotorAngularRateDampingModel.RotorAngularRateDampingSample> samples = new ArrayList<>();
			RotorFlappingForceModel.ConfigurationRotorFlappingForceSample flappingSample = runtimeReplacement
					? runtimeReplacementBaselineRotorFlappingForceSample()
					: baselineRotorFlappingForceSample();
			for (RotorFlappingForceModel.RotorFlappingForceSample rotorSample
					: flappingSample.rotorSamples()) {
				samples.add(RotorAngularRateDampingModel.sample(
						rotorSample.rotor(),
						finiteVecOrZero(angularVelocityBodyRadiansPerSecond),
						rotorSample.effectiveDiskAxisBody(),
						rotorSample.omegaRadiansPerSecond(),
						rotorSample.thrustNewtons(),
						airDensityRatio(),
						1.0,
						0.0,
			...
			return RotorAngularRateDampingModel.aggregate(samples);
		}

		private AirframePressureCenterModel.AirframePressureCenterSample airframePressureCenterSample(
				DroneConfig config,
				AirframeDragForceModel.AirframeDragForceSample dragSample
		) {
			// DronePhysics applies its isotropic linear damper at the center of mass.
			return AirframePressureCenterModel.sampleSteady(
					config,
					relativeAirVelocityBodyMetersPerSecond,
					dragSample.bodyDragForceBodyNewtons(),
					dragSample.effectiveSeparationIntensity()
			);
		}

		private AirframeLiftForceModel.AirframeLiftForceSample airframeLiftSample(
				DroneConfig config,
				AirframeDragForceModel.AirframeDragForceSample dragSample
		) {
			return AirframeLiftForceModel.sampleSteady(
					config,
					relativeAirVelocityBodyMetersPerSecond,
					dragSample.airDensityRatio(),
					dragSample.effectiveSeparationIntensity()
