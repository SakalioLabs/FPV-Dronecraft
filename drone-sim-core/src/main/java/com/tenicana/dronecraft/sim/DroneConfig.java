...
public record DroneConfig(
	...
	public static final double APDRONE_BLACKBOX_LOW_MOTION_GYRO_NOISE_RADIANS_PER_SECOND =
			SensorNoiseCalibration.APDRONE_IMU_LOW_MOTION_GYRO_VECTOR_RMS_P90_RADIANS_PER_SECOND;
	public static final double APDRONE_BLACKBOX_LOW_MOTION_ACCELEROMETER_NOISE_METERS_PER_SECOND_SQUARED =
			SensorNoiseCalibration.APDRONE_IMU_LOW_MOTION_ACCEL_VECTOR_RMS_P90_METERS_PER_SECOND_SQUARED;
	...
	public static DroneConfig racingQuad() {
		...
		return new DroneConfig(
				...
				1.5,
				90.0,
				Math.toRadians(480.0),
				Math.toRadians(360.0),
				Math.toRadians(480.0),
				new Vec3(0.55, 0.45, 0.55),
	...
	public static DroneConfig apDrone() {
		...
		return new DroneConfig(
				...
				1.0,
				125.0,
				APDRONE_BLACKBOX_LOW_MOTION_GYRO_NOISE_RADIANS_PER_SECOND,
				80.0,
				APDRONE_BLACKBOX_LOW_MOTION_ACCELEROMETER_NOISE_METERS_PER_SECOND_SQUARED,
				0.010,
				16.8,
				13.2,
				0.016,
