...
final class PlayableFlightModel {
	...
	private static final float ACRO_THRUST_TURN_LOAD_GAIN = 0.18f;
	private static final float ACRO_THRUST_TURN_LOAD_MAX_ACCELERATION = 1.80f;
	...
	private static final float ACRO_ADVANCE_MAX_THRUST_LOSS = 0.50f;
	private static final float ACRO_ADVANCE_SIDEFLOW_MAX_THRUST_LOSS = 0.66f;
	...
	private static final float ACRO_ROTOR_FLAPPING_COEFFICIENT = 0.081f;
