...
- body-frame quadratic drag plus global drag, with angle-of-attack/sideslip aerodynamic lift, sideforce, dynamic separated-flow build-up/recovery, angle-dependent pressure-center migration, near-ground cushion drag, rotor-wash slipstream drag plus pressure-center moment, and moments;
