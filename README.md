...
Vortex-ring-state mean thrust loss is calibrated against the small-prop reference band around `1.2..1.3 vi`, so a fully loaded vertical descent can lose roughly one third of clean thrust before the separate low-frequency VRS buffet adds unsteady thrust and lateral-force texture.
