...
High-advance blade lift-dissymmetry now feeds a body-frame hub-moment torque and blackbox columns `rotor_blade_dissymmetry_pitch_torque_nm`, `rotor_blade_dissymmetry_yaw_torque_nm`, and `rotor_blade_dissymmetry_roll_torque_nm`, so crosswind or fast forward-flight prop loading can be separated from inflow-skew and rotor-inertia torque.
