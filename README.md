...
The HUD torque line includes flapping force-arm torque as `FT` and active-braking reaction torque as `BT`, next to blade-dissymmetry and wake-swirl hub torque.
