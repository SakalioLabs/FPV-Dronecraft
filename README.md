...
The server self-test validator also requires `rotor_dynamic_inflow_tau_s`, `rotor_5_dynamic_inflow_tau_s`, `rotor_prop_power_scale`, `rotor_5_prop_power_scale`, `rotor_low_reynolds_loss`, `rotor_5_low_reynolds_loss`, `rotor_coning_angle_deg`, `rotor_5_coning_angle_deg`, `rotor_arm_flex_deflection_mm`, `rotor_5_arm_flex_deflection_mm`, `rotor_arm_flex_tilt_deg`, and `rotor_5_arm_flex_tilt_deg`, keeping the automated smoke path aligned with blackbox exports.
