...
The server self-test validator also requires `rotor_dynamic_inflow_tau_s`, `rotor_5_dynamic_inflow_tau_s`, `rotor_prop_power_scale`, `rotor_5_prop_power_scale`, `rotor_low_reynolds_loss`, and `rotor_5_low_reynolds_loss`, keeping the automated smoke path aligned with blackbox exports.
