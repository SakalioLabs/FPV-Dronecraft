...
Status output also includes active-braking reaction torque as `brakeT` and raises `active-brake-torque` when throttle-chop deceleration becomes a handling risk.
...
- active-braking reaction-torque telemetry that separates asymmetric throttle-chop body moments from ordinary rotor inertia, wake-swirl, and blade-dissymmetry hub moments;
