...
Water immersion and precipitation prop-thrust loss is logged as `rotor_wet_thrust_scale`, surfaced live as `wetloss`/`WW`, and raises `wet-thrust-loss` when the wet prop model is visibly reducing authority.
