...
Blackbox summaries print `swirlT`, and the offline recorder summary prints `max_wake_swirl_torque` alongside `max_bdiss_torque`, making peak wake-swirl and blade-dissymmetry hub moments visible in automated tuning runs without opening the CSV.
